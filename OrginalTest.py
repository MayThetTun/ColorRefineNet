...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_images_path', type=str, default="./data/T90/",
                        help='path of input images(underwater images) for testing default:./data/input/')
    parser.add_argument('--output_images_path', type=str, default='./OrgResults/T90/',
    ...
    #                     help='path of label images(clear images) default:./daUIEB ta/label/')
