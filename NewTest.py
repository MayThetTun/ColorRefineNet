...
if __name__ == '__main__':
    ...
    parser.add_argument('--snapshot_path', type=str, default='./SnapShot/SSIMLossAddmodel_epoch_24.ckpt',
                        help='snapshot path,such as :xxx/snapshots/model.ckpt default:None')
    parser.add_argument('--test_images_path', type=str, default="./data/UFO/input/",
                        help='path of input images(underwater images) for testing default:./data/input/')
    parser.add_argument('--output_images_path', type=str, default='./results/UFO_revisetest/',
    ...
    parser.add_argument('--label_images_path', type=str, default="./data/UFO/label/",
