...
from metrics_calculation_2 import calculate_UCIQE
...
if __name__ == '__main__':
    ...
    parser.add_argument('--snapshot_path', type=str, default='./SnapShot/SSIMLossAddmodel_epoch_48.ckpt',
                        help='snapshot path,such as :xxx/snapshots/model.ckpt default:None')
    parser.add_argument('--test_images_path', type=str, default="./data/ColorCheck/",
                        help='path of input images(underwater images) for testing default:./data/input/')
    parser.add_argument('--output_images_path', type=str, default='./PropResult/ColorCheck2/',
